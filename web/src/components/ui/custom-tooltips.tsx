import { chartColors, getColorClassName, AvailableChartColorsKeys } from "@/lib/chartUtils"
import { cx, formatters } from "@/lib/utils"
import { TooltipProps } from "./conditional-bar-chart"
...
export const CustomTooltip4 = ({ payload, active }: TooltipProps) => {
  ...
  const calculateDiff = () => {
    ...
    const formatted = `${Math.abs(difference * 100).toFixed(1)}%`
