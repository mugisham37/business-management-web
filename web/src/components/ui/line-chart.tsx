...
// Helper function to determine badge variant based on evolution value
const getBadgeType = (evolution: number): "success" | "warning" | "destructive" | "primary" => {
  if (evolution > 0) return "success"
  if (evolution < 0) return "destructive"
  return "primary"
}
  ...
  return (
    <li
      className={cx(
        ...
        hasOnValueChange
          ? "bg-transparent cursor-pointer hover:bg-accent"
          : "cursor-default",
      )}
      onClick={(e) => {
        e.stopPropagation()
