      ...
      return (
        <>
          ...
          <Drawer open={openMobile} onOpenChange={setOpenMobile}>
            <DrawerContent className="bg-gray-50 p-0 text-gray-900 dark:bg-gray-950 dark:text-gray-50">
              <VisuallyHidden.Root>
              ...
              <div className="relative flex h-full w-full flex-col">
                <DrawerClose className="absolute right-4 top-4" asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-50"
                  >
