...
export const H1 = ({ children }: React.HTMLProps<HTMLHeadingElement>) => (
  <CustomHeading
    className="text-3xl font-bold normal-case tracking-tight text-foreground sm:text-4xl"
    level={1}
  >
    {children}
  </CustomHeading>
...
export const H2 = ({ children }: React.HTMLProps<HTMLHeadingElement>) => (
  <CustomHeading
    className="mb-4 text-lg font-semibold normal-case tracking-tight text-foreground"
    level={2}
  >
    {children}
  </CustomHeading>
...
export const H3 = ({ children }: React.HTMLProps<HTMLHeadingElement>) => (
  <CustomHeading
    className="mb-2 font-semibold normal-case tracking-tight text-foreground"
    level={3}
  >
    {children}
  </CustomHeading>
...
export const P = (props: React.HTMLProps<HTMLParagraphElement>) => (
  <p {...props} className="mb-8 leading-7 text-muted-foreground" />
)

export const Ul = (props: React.HTMLAttributes<HTMLUListElement>) => (
  <ul
    className="mb-10 ml-[30px] list-['–__'] space-y-1 leading-8 text-muted-foreground"
    {...props}
  />
)
...
export const ChangelogEntry = ({
  ...
  <div className="relative my-20 flex flex-col justify-center gap-x-14 border-b border-border md:flex-row">
    <div className="mb-4 md:mb-10 md:w-1/3">
      <div className="sticky top-24 flex items-center space-x-2 md:block md:space-x-0 md:space-y-1.5">
        <span className="inline-flex items-center rounded-lg bg-primary/10 px-2.5 py-1 text-xs font-medium text-primary ring-1 ring-inset ring-primary/20">
          {version}
        </span>
...
export const ChangelogImage = ({
  ...
  <Image
    ...
    width={width}
    height={height}
    className="mb-10 overflow-hidden rounded-xl shadow-lg ring-1 ring-border/50"
    {...props}
  />
)
