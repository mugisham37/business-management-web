...
export default function CodeExampleTabs({
  ...
  return (
    ...
    >
      ...
      >
        <Tabs.Trigger
          className="group relative flex flex-1 flex-col items-start justify-start rounded-xl p-6 text-left shadow-lg ring-1 ring-border data-[state=active]:shadow-primary/30"
          value="tab1"
        >
          ...
          <p className="text-landing-body mt-4 leading-7">
