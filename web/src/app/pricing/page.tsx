...
export default function Pricing() {
  ...
  return (
    <div className="px-3">
      ...
      >
        <Badge>Pricing</Badge>
        <h1 className="mt-2 inline-block bg-gradient-to-br from-foreground to-foreground/80 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-6xl">
      ...
      >
        <div className="flex items-center justify-center gap-2">
          <Label
            htmlFor="switch"
            className="text-base font-medium text-muted-foreground sm:text-sm"
          >
            Monthly
          </Label>
          <Switch
                ...
                <div className="flex h-4 items-center">
                  <div className="relative w-full">
                    ...
                    <div className="relative flex justify-center">
                      <span className="bg-card px-3 text-xs font-medium text-primary">
                        Most popular
                      </span>
                    </div>
                  </div>
      ...
      >
        <div className="mx-auto space-y-8 sm:max-w-md lg:hidden">
          {plans.map((plan) => (
            <div key={plan.name}>
              <div className="rounded-xl bg-muted/50 p-6 ring-1 ring-inset ring-border">
                <h2
                  id={plan.name}
              ...
              <ul
                role="list"
                className="mt-10 space-y-10 text-sm leading-6 text-foreground"
              >
      ...
      <section className="mx-auto mt-20">
        <div className="mt-20 hidden sm:mt-28 lg:block">
          <div className="relative">
            <div className="sticky top-0 z-20 h-28 w-full bg-background" />
            <table className="w-full table-fixed border-separate border-spacing-0 text-left">
              ...
              <thead className="sticky top-28">
                <tr>
                  <th
                    scope="col"
                    className="border-b border-border bg-background pb-8"
                  >
                    <div className="font-semibold leading-7 text-foreground">
                      Compare prices
                    </div>
                  ...
                  {plans.map((plan) => (
                    <th
                      key={plan.name}
                      scope="col"
                      className="border-b border-border bg-background px-6 pb-8 lg:px-8"
                    >
                      <div
                        className={cx(
                          !plan.isStarter
                  ...
                  <Fragment key={section.name}>
                    <tr>
                      <th
                        ...
                        className={cx(
                          ...
                          "border-b border-border pb-4 text-base font-semibold leading-6 text-foreground",
                        )}
                      >
                        {section.name}
                      </th>
                    ...
                    {section.features.map((feature) => (
                      ...
                      >
                        <th
                          scope="row"
                          className="flex items-center gap-2 border-b border-border py-4 text-sm font-normal leading-6 text-foreground"
                        >
                        ...
                        {plans.map((plan) => (
                          <td
                            key={plan.name}
                            className="border-b border-border px-6 py-4 lg:px-8"
                          >
                            {typeof feature.plans[plan.name] === "string" ? (
                    ...
                    <td key={plan.name} className="px-6 pt-6 lg:px-8">
                      {plan.isStarter ? (
                        ...
                        <Button
                          variant="ghost"
                          asChild
                          className="group bg-transparent px-0 text-base text-primary hover:bg-transparent"
                        >
                          <Link href={plan.buttonLink}>
                            {plan.buttonText}
                            <ArrowAnimated />
