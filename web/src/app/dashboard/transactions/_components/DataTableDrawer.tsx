...
export function DataTableDrawer({
  ...
  const filesList = files.map((file) => (
    ...
    >
      <div className="absolute right-4 top-1/2 -translate-y-1/2">
        <button
          type="button"
          className="rounded-md p-2 text-muted-foreground transition-all hover:text-destructive"
      ...
      <div className="flex items-center space-x-3 truncate">
        ...
        <div className="truncate pr-20">
          <p className="truncate text-xs font-medium text-foreground hover:underline hover:underline-offset-4">
            <a href="#">{file.name}</a>
          </p>
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      {datas ? (
        <DrawerContent className="overflow-x-hidden sm:max-w-lg bg-card">
            ...
            <Tabs defaultValue="details">
              ...
              <TabsContent value="details" className="space-y-6 px-6">
                <div className="mt-6">
                  ...
                  <div className="relative mt-2 flex h-36 items-center justify-center rounded-lg border border-dashed border-border">
                    <div>
                      <File
                      ...
                      <div className="mt-2">
                        <label
                          htmlFor="file-upload"
                          className="cursor-pointer rounded-md text-sm text-foreground"
                        >
                        ...
                        <span className="pl-1 text-sm text-foreground">
          ...
          <DrawerFooter className="-mx-6 -mb-2 gap-2 bg-card px-6">
            <DrawerClose>
