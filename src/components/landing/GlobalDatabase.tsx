  ...
  return (
    <div className="px-3">
      <section
        ...
        className="relative mx-auto mt-28 flex w-full max-w-6xl flex-col items-center justify-center overflow-hidden rounded-3xl bg-gray-950 pt-24 shadow-xl shadow-primary/30 md:mt-40 dark:bg-gray-950"
      >
        ...
        <h2
          ...
          className="z-10 mt-6 inline-block bg-gradient-to-b from-foreground to-primary-foreground bg-clip-text px-2 text-center text-5xl font-bold tracking-tighter text-transparent md:text-8xl"
        >
        ...
        <div className="z-20 -mt-32 h-[36rem] w-full overflow-hidden md:-mt-36">
          ...
          <div className="absolute inset-x-6 bottom-12 m-auto max-w-4xl md:top-2/3">
            <div className="grid grid-cols-1 gap-x-10 gap-y-6 rounded-lg border border-foreground/[3%] bg-foreground/[1%] px-6 py-6 shadow-xl backdrop-blur md:grid-cols-3 md:p-8">
              {features.map((item) => (
                <div key={item.name} className="flex flex-col gap-2">
                  <h3 className="whitespace-nowrap bg-gradient-to-b from-primary to-primary/80 bg-clip-text text-lg font-semibold text-transparent md:text-xl">
                    {item.name}
                  </h3>
                  <p className="text-sm leading-6 text-primary-foreground/40">
                    {item.description}
                  </p>
                </div>
              ))}
