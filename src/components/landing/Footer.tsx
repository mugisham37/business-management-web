                      ...
                      >
                        ...
                        {item.external && (
                          <div className="ml-1 aspect-square size-3 rounded-full bg-muted p-px">
                            <RiArrowRightUpLine
                              aria-hidden="true"
                              className="size-full shrink-0 text-muted-foreground"
                            />
                          </div>
                        )}
                      </Link>
          ...
          <div className="rounded-full border border-border py-1 pl-1 pr-2">
            <div className="flex items-center gap-1.5">
              <div className="relative size-4 shrink-0">
                <div className="absolute inset-[1px] rounded-full bg-chart-5/20" />
                <div className="absolute inset-1 rounded-full bg-chart-5" />
              </div>
