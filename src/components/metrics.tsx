...
const METRICS_DATA = [
  {
    ...
    containerClass: "framer-tsx8xw-container"
  },
  {
    value: "0%+",
    title: "Task Completion Rate",
    description: "Tasks are completed faster, with fewer delays.",
    containerClass: "framer-829xnn-container"
  },
  {
    value: "0.0",
    title: "User Satisfaction Score",
    description: "Praised for speed, clarity, and collaboration.",
    containerClass: "framer-14haea7-container"
  }
]

// MetricCard component
const MetricCard = ({ value, title, description, containerClass }: {
  value: string
  title: string
  description: string
  ...
  <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
    <div className={containerClass} style={{willChange: "transform", opacity: 0, transform: "translateY(50px)"}}>
      <div 
        className="framer-JxHMO framer-Fz19O framer-ae7Kc framer-1c2l40y framer-v-xomy8p"
        data-border="true" 
        data-framer-name="Phone"
        style={COMMON_STYLES.cardBorder}
      >
        <div className="framer-sqwghv-container" data-code-component-plugin-id="84d4c1" style={{opacity: 1}}>
          <div style={COMMON_STYLES.metricValue}>
            <span style={COMMON_STYLES.metricSpan}>{value}</span>
          </div>
        </div>
        <div className="framer-k5r3gi" data-framer-name="Heading &amp; Supporting Text" style={{opacity: 1}}>
          <div 
          ...
          >
            <h5 
              className="framer-text framer-styles-preset-ggytww"
...
const Metrics = () => {
  return (
    <section className="framer-1pa1ld7" data-framer-name="Metrics Section" id="metrics">
      <div className="framer-undybe" data-framer-name="Container">
        <div className="framer-ijraud" data-framer-name="Heading &amp; Metrics">
          <div className="framer-1f1fu3y" data-framer-name="Heading Container">
            <div className="framer-qpdsiq" data-framer-name="Heading &amp; Metrics">
              <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                <div className="framer-fvacvm-container">
                  <div 
                  ...
                  >
                    <div className="framer-1l1ajhh" data-framer-name="Icon" style={{opacity: 1}}>
                      <svg 
                        className="framer-qmZa7 framer-qgvfsn" 
                        role="presentation"
                        viewBox="0 0 24 24"
                        style={{
                          "--1m6trwb": "0",
              ...
              <div className="framer-1gyaur3" data-framer-name="Heading Content">
                <div className="framer-efdq3r" data-framer-name="Container">
                  <div 
                    className="framer-1w67ycn" 
            ...
            <div className="framer-nan1a8" data-framer-name="Metrics">
