            ...
            <div className="framer-d9t47k" data-framer-name="Container">
                ...
                <div className="framer-elwthe" data-framer-name="Benefits Card">
                    <div className="framer-1b0b1iz" data-framer-name="Grid">
                                        ...
                                        <div className="framer-1qvo9d"
                                            ...
                                            <div className="framer-9wmgkb"
                                                ...
                                                <h6 className="framer-text framer-styles-preset-ggytww"
                                                    ...
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Zero Overlap Planning
                                                </h6>
                                            </div>
                                            <div className="framer-pw26ej"
                                                ...
                                                <p className="framer-text framer-styles-preset-wct5n4"
                                                    ...
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Prevent task
                                                    conflicts with built-in smart scheduling.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                            <div className="framer-1byjm1j-container"
                                style={{ willChange: "transform", opacity: "0", transform: "translateY(50px)" }}>
                                <div className="framer-CpbJJ framer-Fz19O framer-ae7Kc framer-uyvmox framer-v-uyvmox"
                                    data-border="true" data-framer-name="Primary - Blue"
                                    style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-64e377a5-0d6a-419d-892d-eb08deb7230b, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-44021ae2-4cdd-419c-805c-4b1fd642bfaa, rgb(255, 255, 255))", width: "100%", borderRadius: "10px", boxShadow: "0px 2px 5px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1" } as React.CSSProperties}>
                                    <div className="framer-1lv4fag" data-framer-name="Container"
                                        ...
                                        <div className="framer-et94s" data-framer-name="Icon"
                                            style={{ backgroundColor: "var(--token-63f804c8-3c4f-490d-9524-ef19f06222dd, rgb(240, 248, 255))", borderRadius: "8px", opacity: "1" }}>
                                            <svg className="framer-Nsb3W framer-i7dtij" role="presentation"
                                                viewBox="0 0 24 24"
                                                style={{ "--1m6trwb": "0", "--21h8s6": "var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(66, 135, 255))", "--pgex8v": "1.5", opacity: "1" } as React.CSSProperties}>
                                                <use href="#1067826548"></use>
                                            </svg></div>
                                        <div className="framer-1qvo9d"
                                            data-framer-name="Heading &amp; Supporting Text"
                                            style={{ opacity: "1" }}>
                                            <div className="framer-9wmgkb"
                                                ...
                                                <h6 className="framer-text framer-styles-preset-ggytww"
                                                    data-styles-preset="xhIf5qL2n"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Click-to-Act
                                                    Notifications</h6>
                                            </div>
                                            <div className="framer-pw26ej"
                                                data-framer-component-type="RichTextContainer"
                                                ...
                                                <p className="framer-text framer-styles-preset-wct5n4"
                                                    data-styles-preset="OvgFe4dMx"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Act fast with
                                                    alerts—no clutter or missed updates.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                            <div className="framer-gjy4pe-container"
                                style={{ willChange: "transform", opacity: "0", transform: "translateY(50px)" }}>
                                <div className="framer-CpbJJ framer-Fz19O framer-ae7Kc framer-uyvmox framer-v-uyvmox"
                                    data-border="true" data-framer-name="Primary - Blue"
                                    style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-64e377a5-0d6a-419d-892d-eb08deb7230b, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-44021ae2-4cdd-419c-805c-4b1fd642bfaa, rgb(255, 255, 255))", width: "100%", borderRadius: "10px", boxShadow: "0px 2px 5px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1" } as React.CSSProperties}>
                                    <div className="framer-1lv4fag" data-framer-name="Container"
                                        ...
                                        <div className="framer-et94s" data-framer-name="Icon"
                                            style={{ backgroundColor: "var(--token-63f804c8-3c4f-490d-9524-ef19f06222dd, rgb(240, 248, 255))", borderRadius: "8px", opacity: "1" }}>
                                            <svg className="framer-rpolD framer-i7dtij" role="presentation"
                                                viewBox="0 0 24 24"
                                                style={{ "--1m6trwb": "0", "--21h8s6": "var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(66, 135, 255))", "--pgex8v": "1.5", opacity: "1" } as React.CSSProperties}>
                                                <use href="#2840072777"></use>
                                            </svg></div>
                                        <div className="framer-1qvo9d"
                                            data-framer-name="Heading &amp; Supporting Text"
                                            style={{ opacity: "1" }}>
                                            <div className="framer-9wmgkb"
                                                ...
                                                <h6 className="framer-text framer-styles-preset-ggytww"
                                                    data-styles-preset="xhIf5qL2n"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Offline-Ready Sync
                                                </h6>
                                            </div>
                                            <div className="framer-pw26ej"
                                                data-framer-component-type="RichTextContainer"
                                                ...
                                                <p className="framer-text framer-styles-preset-wct5n4"
                                                    data-styles-preset="OvgFe4dMx"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Stay synced—updates
                                                    auto-load once you're online.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                            <div className="framer-2vythu-container"
                                style={{ willChange: "transform", opacity: "0", transform: "translateY(50px)" }}>
                                <div className="framer-CpbJJ framer-Fz19O framer-ae7Kc framer-uyvmox framer-v-uyvmox"
                                    data-border="true" data-framer-name="Primary - Blue"
                                    style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-64e377a5-0d6a-419d-892d-eb08deb7230b, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-44021ae2-4cdd-419c-805c-4b1fd642bfaa, rgb(255, 255, 255))", width: "100%", borderRadius: "10px", boxShadow: "0px 2px 5px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1" } as React.CSSProperties}>
                                    <div className="framer-1lv4fag" data-framer-name="Container"
                                        ...
                                        <div className="framer-et94s" data-framer-name="Icon"
                                            style={{ backgroundColor: "var(--token-63f804c8-3c4f-490d-9524-ef19f06222dd, rgb(240, 248, 255))", borderRadius: "8px", opacity: "1" }}>
                                            <svg className="framer-DkID7 framer-i7dtij" role="presentation"
                                                viewBox="0 0 24 24"
                                                style={{ "--1m6trwb": "0", "--21h8s6": "var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(66, 135, 255))", "--pgex8v": "1.5", opacity: "1" } as React.CSSProperties}>
                                                <use href="#987190984"></use>
                                            </svg></div>
                                        <div className="framer-1qvo9d"
                                            data-framer-name="Heading &amp; Supporting Text"
                                            style={{ opacity: "1" }}>
                                            <div className="framer-9wmgkb"
                                                ...
                                                <h6 className="framer-text framer-styles-preset-ggytww"
                                                    data-styles-preset="xhIf5qL2n"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Built-In Audit Trail
                                                </h6>
                                            </div>
                                            <div className="framer-pw26ej"
                                                data-framer-component-type="RichTextContainer"
                                                ...
                                                <p className="framer-text framer-styles-preset-wct5n4"
                                                    data-styles-preset="OvgFe4dMx"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Track every edit and
                                                    action with built-in transparency.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                            <div className="framer-1yzioh6-container"
                                style={{ willChange: "transform", opacity: "0", transform: "translateY(50px)" }}>
                                <div className="framer-CpbJJ framer-Fz19O framer-ae7Kc framer-uyvmox framer-v-uyvmox"
                                    data-border="true" data-framer-name="Primary - Blue"
                                    style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-64e377a5-0d6a-419d-892d-eb08deb7230b, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-44021ae2-4cdd-419c-805c-4b1fd642bfaa, rgb(255, 255, 255))", width: "100%", borderRadius: "10px", boxShadow: "0px 2px 5px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1" } as React.CSSProperties}>
                                    <div className="framer-1lv4fag" data-framer-name="Container"
                                        ...
                                        <div className="framer-et94s" data-framer-name="Icon"
                                            style={{ backgroundColor: "var(--token-63f804c8-3c4f-490d-9524-ef19f06222dd, rgb(240, 248, 255))", borderRadius: "8px", opacity: "1" }}>
                                            <svg className="framer-dI88f framer-i7dtij" role="presentation"
                                                viewBox="0 0 24 24"
                                                style={{ "--1m6trwb": "0", "--21h8s6": "var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(66, 135, 255))", "--pgex8v": "1.5", opacity: "1" } as React.CSSProperties}>
                                                <use href="#1283949305"></use>
                                            </svg></div>
                                        <div className="framer-1qvo9d"
                                            data-framer-name="Heading &amp; Supporting Text"
                                            style={{ opacity: "1" }}>
                                            <div className="framer-9wmgkb"
                                                ...
                                                <h6 className="framer-text framer-styles-preset-ggytww"
                                                    data-styles-preset="xhIf5qL2n"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Smart Recurring Tasks
                                                </h6>
                                            </div>
                                            <div className="framer-pw26ej"
                                                data-framer-component-type="RichTextContainer"
                                                ...
                                                <p className="framer-text framer-styles-preset-wct5n4"
                                                    data-styles-preset="OvgFe4dMx"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Automate with
                                                    flexible task logic and helpful reminders.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                            <div className="framer-g81xr9-container"
                                style={{ willChange: "transform", opacity: "0", transform: "translateY(50px)" }}>
                                <div className="framer-CpbJJ framer-Fz19O framer-ae7Kc framer-uyvmox framer-v-uyvmox"
                                    data-border="true" data-framer-name="Primary - Blue"
                                    style={{ "--border-bottom-width": "1px", "--border-color": "var(--token-64e377a5-0d6a-419d-892d-eb08deb7230b, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-44021ae2-4cdd-419c-805c-4b1fd642bfaa, rgb(255, 255, 255))", width: "100%", borderRadius: "10px", boxShadow: "0px 2px 5px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1" } as React.CSSProperties}>
                                    <div className="framer-1lv4fag" data-framer-name="Container"
                                        ...
                                        <div className="framer-et94s" data-framer-name="Icon"
                                            style={{ backgroundColor: "var(--token-63f804c8-3c4f-490d-9524-ef19f06222dd, rgb(240, 248, 255))", borderRadius: "8px", opacity: "1" }}>
                                            <svg className="framer-p3lRU framer-i7dtij" role="presentation"
                                                viewBox="0 0 24 24"
                                                style={{ "--1m6trwb": "0", "--21h8s6": "var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(66, 135, 255))", "--pgex8v": "1.5", opacity: "1" } as React.CSSProperties}>
                                                <use href="#3494739676"></use>
                                            </svg></div>
                                        <div className="framer-1qvo9d"
                                            data-framer-name="Heading &amp; Supporting Text"
                                            style={{ opacity: "1" }}>
                                            <div className="framer-9wmgkb"
                                                ...
                                                <h6 className="framer-text framer-styles-preset-ggytww"
                                                    data-styles-preset="xhIf5qL2n"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Human-Centered Design
                                                </h6>
                                            </div>
                                            <div className="framer-pw26ej"
                                                data-framer-component-type="RichTextContainer"
                                                ...
                                                <p className="framer-text framer-styles-preset-wct5n4"
                                                    data-styles-preset="OvgFe4dMx"
                                                    style={{ "--framer-text-alignment": "left" } as React.CSSProperties}>Built for clarity,
                                                    ease, and real-world user needs and habits.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
