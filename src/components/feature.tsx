    ...
    <section className="framer-1k4v191" data-framer-name="Feature Section" id="feature">
                    <div className="framer-m2cf04" data-framer-name="Container">
                        <div className="framer-12vv10h" data-framer-name="Heading &amp; Image">
                                ...
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-1930j7g" data-framer-name="Image">
                                        <div data-framer-background-image-wrapper="true"
                                            style={{position: "absolute", borderRadius: "inherit", inset: "0px"} as React.CSSProperties}><img
                            ...
                            <div className="framer-g75fwc" data-framer-name="Heading &amp; Supporting Text">
                                <div className="framer-157nuz9" data-framer-name="Heading Container">
                                        ...
                                        <div className="framer-jxcqf0-container">
                                            <div className="framer-Fhx2V framer-YF6mi framer-18xhfg8 framer-v-18xhfg8"
                                                ...
                                                <div className="framer-1l1ajhh" data-framer-name="Icon" style={{opacity: "1"} as React.CSSProperties}>
                                                    <svg className="framer-BpUsM framer-qgvfsn" role="presentation"
                                                        viewBox="0 0 24 24"
                                    ...
                                    <div className="framer-1h3j3nj" data-framer-name="Heading Content">
                                        <div className="framer-15ylilk" data-framer-name="Container">
                                            <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                                <div className="framer-xphh5z" data-framer-name="Heading"
                                                    data-framer-component-type="RichTextContainer"
                                                    ...
                                                    <h2 className="framer-text framer-styles-preset-199apa9"
                                                        ...
                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Smarter task
                                                        management, built for teams.</h2>
                                                </div>
                                            </div>
                                            <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                                <div className="framer-14b3j8t" data-framer-name="Supporting text"
                                                    data-framer-component-type="RichTextContainer"
                                                    style={{outline: "none", display: "flex", flexDirection: "column", justifyContent: "flex-start", flexShrink: "0", transform: "none"} as React.CSSProperties}>
                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                        data-styles-preset="OvgFe4dMx"
                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>From task planning to
                                ...
                                <div className="framer-1kqwlfv" data-framer-name="Feature List">
                                    <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                        <div className="framer-18bz47u-container">
                                            <div className="framer-v2mcq framer-ae7Kc framer-qz94l0 framer-v-qz94l0"
                                                data-border="true" data-framer-name="Feature List"
                                                style={{"--border-bottom-width": "1px", "--border-color": "var(--token-ccc95a9a-25f2-49cc-a0af-ecdbff23bfba, rgb(214, 214, 214))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e9d5663e-56be-412a-882e-587896e30dd7, rgba(247, 249, 250, 0.5))", borderRadius: "16px", boxShadow: "0px 1px 3px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1"} as React.CSSProperties}>
                                                <div className="framer-12ix1hz" data-framer-name="Icon" style={{opacity: "1"} as React.CSSProperties}>
                                                    <div className="framer-WzIzJ framer-184qdzk"
                                                        style={{"--21h8s6": "var(--token-53318a49-e2d8-4d3b-98d7-8563add13d3d, rgb(56, 56, 61))", opacity: "1"} as React.CSSProperties}>
                                                    </div>
                                                </div>
                                                <div className="framer-286iq4" data-framer-name="Supporting text"
                                                    data-framer-component-type="RichTextContainer"
                                                    ...
                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                        data-styles-preset="OvgFe4dMx"
                                                        style={{"--framer-text-alignment": "left"} as React.CSSProperties}>Structured for clarity
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                        <div className="framer-1k05kbd-container">
                                            <div className="framer-v2mcq framer-ae7Kc framer-qz94l0 framer-v-qz94l0"
                                                data-border="true" data-framer-name="Feature List"
                                                style={{"--border-bottom-width": "1px", "--border-color": "var(--token-ccc95a9a-25f2-49cc-a0af-ecdbff23bfba, rgb(214, 214, 214))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e9d5663e-56be-412a-882e-587896e30dd7, rgba(247, 249, 250, 0.5))", borderRadius: "16px", boxShadow: "0px 1px 3px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1"} as React.CSSProperties}>
                                                <div className="framer-12ix1hz" data-framer-name="Icon" style={{opacity: "1"} as React.CSSProperties}>
                                                    <div className="framer-zLRAx framer-184qdzk"
                                                        style={{"--21h8s6": "var(--token-53318a49-e2d8-4d3b-98d7-8563add13d3d, rgb(56, 56, 61))", opacity: "1"} as React.CSSProperties}>
                                                    </div>
                                                </div>
                                                <div className="framer-286iq4" data-framer-name="Supporting text"
                                                    ...
                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                        data-styles-preset="OvgFe4dMx"
                                                        style={{"--framer-text-alignment": "left"} as React.CSSProperties}>Launch-ready in minutes
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                        <div className="framer-11ubpo2-container">
                                            <div className="framer-v2mcq framer-ae7Kc framer-qz94l0 framer-v-qz94l0"
                                                data-border="true" data-framer-name="Feature List"
                                                style={{"--border-bottom-width": "1px", "--border-color": "var(--token-ccc95a9a-25f2-49cc-a0af-ecdbff23bfba, rgb(214, 214, 214))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e9d5663e-56be-412a-882e-587896e30dd7, rgba(247, 249, 250, 0.5))", borderRadius: "16px", boxShadow: "0px 1px 3px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1"} as React.CSSProperties}>
                                                <div className="framer-12ix1hz" data-framer-name="Icon" style={{opacity: "1"} as React.CSSProperties}>
                                                    <svg className="framer-b8top framer-184qdzk" role="presentation"
                                                        viewBox="0 0 24 24"
                                                ...
                                                <div className="framer-286iq4" data-framer-name="Supporting text"
                                                    ...
                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                        data-styles-preset="OvgFe4dMx"
                                                        style={{"--framer-text-alignment": "left"} as React.CSSProperties}>Clean and focused UX</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                        <div className="framer-bc7zb1-container">
                                            <div className="framer-v2mcq framer-ae7Kc framer-qz94l0 framer-v-qz94l0"
                                                data-border="true" data-framer-name="Feature List"
                                                style={{"--border-bottom-width": "1px", "--border-color": "var(--token-ccc95a9a-25f2-49cc-a0af-ecdbff23bfba, rgb(214, 214, 214))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e9d5663e-56be-412a-882e-587896e30dd7, rgba(247, 249, 250, 0.5))", borderRadius: "16px", boxShadow: "0px 1px 3px 0px var(--token-0c21c7c4-decf-4cb8-98b2-1f4ecf98c018, rgb(248, 249, 250))", opacity: "1"} as React.CSSProperties}>
                                                <div className="framer-12ix1hz" data-framer-name="Icon" style={{opacity: "1"} as React.CSSProperties}>
                                                    <div className="framer-eKeIr framer-184qdzk"
                                                        style={{"--21h8s6": "var(--token-53318a49-e2d8-4d3b-98d7-8563add13d3d, rgb(56, 56, 61))", opacity: "1"} as React.CSSProperties}>
                                                    </div>
                                                </div>
                                                <div className="framer-286iq4" data-framer-name="Supporting text"
                                                    ...
                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                        data-styles-preset="OvgFe4dMx"
                                                        style={{"--framer-text-alignment": "left"} as React.CSSProperties}>Scales with complex teams
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="framer-oj6pqy" data-framer-name="Feature Card">
                            <div className="framer-7f809f" data-framer-name="Feature Card 1" id="feature-card-1">
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-ldvkts-container"
                                        style={{willChange: "transform", opacity: "0", transform: "translateY(80px)"} as React.CSSProperties}>
                                        <div className="framer-Bmxwm framer-YF6mi framer-DZNJn framer-cx3hr framer-ae7Kc framer-1l6rd07 framer-v-576xtk"
                                            ...
                                            style={{"--border-bottom-width": "1px", "--border-color": "var(--token-9cf61545-9ec8-4c23-873d-6ec7f44bfe14, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e1c52d29-6b20-4ee3-afb3-f179ac191e9c, rgb(251, 251, 251))", width: "100%", borderRadius: "15px", opacity: "1"} as React.CSSProperties}>
                                            <div className="framer-dfpa4m" data-framer-name="Container" style={{opacity: "1"} as React.CSSProperties}>
                                                <div className="framer-1b1cgne" data-framer-name="Heading &amp; Button"
                                                    style={{opacity: "1"} as React.CSSProperties}>
                                                    <div className="framer-9ocz71" data-framer-name="Container"
                                                        style={{opacity: "1"} as React.CSSProperties}>
                                                        <div className="framer-k2ztwh" data-framer-name="Highlight  Badge"
                                                            style={{borderRadius: "5px", opacity: "1"} as React.CSSProperties}>
                                                        ...
                                                        <div className="framer-1qlhb8w"
                                                            data-framer-name="Heading &amp; Button" style={{opacity: "1"} as React.CSSProperties}>
                                                            <div className="framer-xk7xl5"
                                                                data-framer-name="Heading &amp; Supporting Text"
                                                                style={{opacity: "1"} as React.CSSProperties}>
                                                                <div className="framer-1ddp2mg"
                                                                    data-framer-component-type="RichTextContainer"
                                                                    style={{outline: "none", display: "flex", flexDirection: "column", justifyContent: "flex-start", flexShrink: "0", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1"} as React.CSSProperties}>
                                                                    <h4 className="framer-text framer-styles-preset-15b5etd"
                                                                        data-styles-preset="amESisFWp"
                                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Smart
                                                                        Assignment</h4>
                                                                </div>
                                                                <div className="framer-3wkqb4"
                                                                    data-framer-component-type="RichTextContainer"
                                                                    style={{outline: "none", display: "flex", flexDirection: "column", justifyContent: "flex-start", flexShrink: "0", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", transform: "none", opacity: "1"} as React.CSSProperties}>
                                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                                        data-styles-preset="OvgFe4dMx"
                                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Assign
                                                            ...
                                                            <div className="framer-1kdkvgi-container" style={{opacity: "1"} as React.CSSProperties}><a
                                                                    className="framer-i8Jnw framer-YF6mi framer-1jz64ot framer-v-1uge9f framer-1jhx1jk"
                                                                    ...
                                                                    <div className="framer-12n0srg"
                                                                        data-framer-name="Container"
                                                                        style={{opacity: "1"} as React.CSSProperties}>
                                                                        <div className="framer-1669q28"
                                                                            data-framer-name="Text" style={{opacity: "1"} as React.CSSProperties}>
                                                                            <div className="framer-1fovsuz"
                                                                        ...
                                                                        <div className="framer-1mxeorf"
                                                                            ...
                                                                            <div className="framer-nrss4v-container"
                                                                                style={{opacity: "1"} as React.CSSProperties}>
                                                                                <div style={{display: "contents"} as React.CSSProperties}><svg
                                                ...
                                                <div className="framer-1yqsjdc" data-framer-name="Image"
                                                    style={{opacity: "1"} as React.CSSProperties}>
                                                    <div className="framer-n906kc" data-framer-name="Image"
                                                        style={{borderRadius: "5px", opacity: "1"} as React.CSSProperties}>
                                                        <div data-framer-background-image-wrapper="true"
                            ...
                            <div className="framer-btd29u" data-framer-name="Feature Card 2" id="feature-card-2">
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-53gamc-container"
                                        style={{willChange: "transform", opacity: "0", transform: "translateY(80px)"} as React.CSSProperties}>
                                        <div className="framer-Bmxwm framer-YF6mi framer-DZNJn framer-cx3hr framer-ae7Kc framer-1l6rd07 framer-v-576xtk"
                                            data-border="true" data-framer-name="Phone"
                                            style={{"--border-bottom-width": "1px", "--border-color": "var(--token-9cf61545-9ec8-4c23-873d-6ec7f44bfe14, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e1c52d29-6b20-4ee3-afb3-f179ac191e9c, rgb(251, 251, 251))", width: "100%", borderRadius: "15px", opacity: "1"} as React.CSSProperties}>
                                                        ...
                                                        <div className="framer-1qlhb8w"
                                                            ...
                                                            <div className="framer-xk7xl5"
                                                                ...
                                                                <div className="framer-1ddp2mg"
                                                                    ...
                                                                    <h4 className="framer-text framer-styles-preset-15b5etd"
                                                                        data-styles-preset="amESisFWp"
                                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Visual
                                                                ...
                                                                <div className="framer-3wkqb4"
                                                                    ...
                                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                                        data-styles-preset="OvgFe4dMx"
                                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Track
                            ...
                            <div className="framer-7relri" data-framer-name="Feature Card 3" id="feature-card-3">
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-rgj3tr-container"
                                        style={{willChange: "transform", opacity: "0", transform: "translateY(80px)"} as React.CSSProperties}>
                                        <div className="framer-Bmxwm framer-YF6mi framer-DZNJn framer-cx3hr framer-ae7Kc framer-1l6rd07 framer-v-576xtk"
                                            data-border="true" data-framer-name="Phone"
                                            style={{"--border-bottom-width": "1px", "--border-color": "var(--token-9cf61545-9ec8-4c23-873d-6ec7f44bfe14, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e1c52d29-6b20-4ee3-afb3-f179ac191e9c, rgb(251, 251, 251))", width: "100%", borderRadius: "15px", opacity: "1"} as React.CSSProperties}>
                                                        ...
                                                        <div className="framer-1qlhb8w"
                                                            ...
                                                            <div className="framer-xk7xl5"
                                                                ...
                                                                <div className="framer-3wkqb4"
                                                                    ...
                                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                                        data-styles-preset="OvgFe4dMx"
                                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Work
                            ...
                            <div className="framer-1sf7l75" data-framer-name="Feature Card 4" id="feature-card-4">
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-zmldoc-container"
                                        style={{willChange: "transform", opacity: "0", transform: "translateY(80px)"} as React.CSSProperties}>
                                        <div className="framer-Bmxwm framer-YF6mi framer-DZNJn framer-cx3hr framer-ae7Kc framer-1l6rd07 framer-v-576xtk"
                                            data-border="true" data-framer-name="Phone"
                                            style={{"--border-bottom-width": "1px", "--border-color": "var(--token-9cf61545-9ec8-4c23-873d-6ec7f44bfe14, rgb(229, 229, 232))", "--border-left-width": "1px", "--border-right-width": "1px", "--border-style": "solid", "--border-top-width": "1px", backgroundColor: "var(--token-e1c52d29-6b20-4ee3-afb3-f179ac191e9c, rgb(251, 251, 251))", width: "100%", borderRadius: "15px", opacity: "1"} as React.CSSProperties}>
                                                        ...
                                                        <div className="framer-1qlhb8w"
                                                            ...
                                                            <div className="framer-xk7xl5"
                                                                ...
                                                                <div className="framer-3wkqb4"
                                                                    ...
                                                                    <p className="framer-text framer-styles-preset-wct5n4"
                                                                        data-styles-preset="OvgFe4dMx"
                                                                        style={{"--framer-text-alignment": "center"} as React.CSSProperties}>Switch
