                    ...
                    <div className="framer-ttr560" data-framer-name="Container">
                        ...
                        <div className="framer-1nmcetb" data-framer-name="FAQ List">
                            <div className="framer-hdc7uo" data-framer-name="FAQ">
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-79veun-container"
                                        style={{"willChange":"transform","opacity":"0","transform":"translateY(50px)"} as any}>
                                        <div className="framer-m9QRL framer-Fz19O framer-ae7Kc framer-12gnatm framer-v-12gnatm"
                                            ...
                                            tabIndex={0}
                                            style={{"-BorderBottomWidth":"1px","-BorderColor":"var(--token-64e377a5-0d6a-419d-892d-eb08deb7230b, rgb(229, 229, 232))","-BorderLeftWidth":"1px","-BorderRightWidth":"1px","-BorderStyle":"solid","-BorderTopWidth":"1px","backgroundColor":"var(--token-e1c52d29-6b20-4ee3-afb3-f179ac191e9c, rgb(251, 251, 251))","width":"100%","borderRadius":"10px","opacity":"1"} as any}>
                                                ...
                                                <div className="framer-1t5jbla" data-framer-name="Content"
                                                    ...
                                                    <div className="framer-i4y2k1" data-framer-name="Heading"
                                                        ...
                                                        <div className="framer-sml1t9"
                                                            data-framer-component-type="RichTextContainer"
                                                            style={{"outline":"none","display":"flex","flexDirection":"column","justifyContent":"flex-start","flexShrink":"0","-Extracted-1w1cjl5":"var(--token-d3c732bc-55cf-476f-8dd2-e130b23f6381, rgb(38, 38, 38))","transform":"none","opacity":"1"} as any}>
                                                            <h6 className="framer-text framer-styles-preset-ggytww"
                                                                data-styles-preset="xhIf5qL2n"
                                                                style={{"-FramerTextAlignment":"left","-FramerTextColor":"var(--extracted-1w1cjl5, var(--token-d3c732bc-55cf-476f-8dd2-e130b23f6381, rgb(38, 38, 38)))"} as any}>
                                                                What makes this task tool different from others?</h6>
                                                        </div>
                                                        <div className="framer-1wfqlvf" data-framer-name="Icon"
                                                            ...
                                                            <div className="framer-1dnucf6" data-framer-name="Plus"
                                                                ...
                                                                <div className="framer-1xuhs5x"
                                                                    style={{"backgroundColor":"var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(0, 94, 255))","borderRadius":"1px","opacity":"1"} as any}>
                                                                </div>
                                                                <div className="framer-1jeieso"
                                                                    style={{"backgroundColor":"var(--token-d602a9d1-da3b-45d6-b039-eac0d7c79341, rgb(0, 94, 255))","borderRadius":"1px","transform":"rotate(90deg)","opacity":"1"} as any}>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-ooyuop-container"
                                        style={{"willChange":"transform","opacity":"0","transform":"translateY(50px)"} as any}>
                                        <div className="framer-m9QRL framer-Fz19O framer-ae7Kc framer-12gnatm framer-v-12gnatm"
                                            data-border="true" data-framer-name="Closed" data-highlight="true"
                                            tabIndex={0}
                                                    ...
                                                    <div className="framer-i4y2k1" data-framer-name="Heading"
                                                        ...
                                                        <div className="framer-sml1t9"
                                                            ...
                                                            <h6 className="framer-text framer-styles-preset-ggytww"
                                                                data-styles-preset="xhIf5qL2n"
                                                                style={{"-FramerTextAlignment":"left","-FramerTextColor":"var(--extracted-1w1cjl5, var(--token-d3c732bc-55cf-476f-8dd2-e130b23f6381, rgb(38, 38, 38)))"} as any}>
                                                                Can I use this for a large team or company?</h6>
                                                        </div>
                                                        <div className="framer-1wfqlvf" data-framer-name="Icon"
                                                            style={{"opacity":"1"} as any}>
                                                            <div className="framer-1dnucf6" data-framer-name="Plus"
                                ...
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-9i9mut-container"
                                        style={{"willChange":"transform","opacity":"0","transform":"translateY(50px)"} as any}>
                                        <div className="framer-m9QRL framer-Fz19O framer-ae7Kc framer-12gnatm framer-v-12gnatm"
                                            data-border="true" data-framer-name="Closed" data-highlight="true"
                                            tabIndex={0}
                                                    ...
                                                    <div className="framer-i4y2k1" data-framer-name="Heading"
                                                        ...
                                                        <div className="framer-sml1t9"
                                                            ...
                                                            <h6 className="framer-text framer-styles-preset-ggytww"
                                                                data-styles-preset="xhIf5qL2n"
                                                                style={{"-FramerTextAlignment":"left","-FramerTextColor":"var(--extracted-1w1cjl5, var(--token-d3c732bc-55cf-476f-8dd2-e130b23f6381, rgb(38, 38, 38)))"} as any}>
                                                                Is the AI really useful or just a gimmick?</h6>
                                                        </div>
                                                        <div className="framer-1wfqlvf" data-framer-name="Icon"
                                                            style={{"opacity":"1"} as any}>
                                                            <div className="framer-1dnucf6" data-framer-name="Plus"
                                ...
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-3f2xph-container"
                                        style={{"willChange":"transform","opacity":"0","transform":"translateY(50px)"} as any}>
                                        <div className="framer-m9QRL framer-Fz19O framer-ae7Kc framer-12gnatm framer-v-12gnatm"
                                            data-border="true" data-framer-name="Closed" data-highlight="true"
                                            tabIndex={0}
                                                    ...
                                                    <div className="framer-i4y2k1" data-framer-name="Heading"
                                                        ...
                                                        <div className="framer-sml1t9"
                                                            ...
                                                            <h6 className="framer-text framer-styles-preset-ggytww"
                                                                data-styles-preset="xhIf5qL2n"
                                                                style={{"-FramerTextAlignment":"left","-FramerTextColor":"var(--extracted-1w1cjl5, var(--token-d3c732bc-55cf-476f-8dd2-e130b23f6381, rgb(38, 38, 38)))"} as any}>
                                                                What integrations are supported?</h6>
                                                        </div>
                                                        <div className="framer-1wfqlvf" data-framer-name="Icon"
                                                            style={{"opacity":"1"} as any}>
                                                            <div className="framer-1dnucf6" data-framer-name="Plus"
                                ...
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-y81tcp-container"
                                        style={{"willChange":"transform","opacity":"0","transform":"translateY(50px)"} as any}>
                                        <div className="framer-m9QRL framer-Fz19O framer-ae7Kc framer-12gnatm framer-v-12gnatm"
                                            data-border="true" data-framer-name="Closed" data-highlight="true"
                                            tabIndex={0}
                                ...
                                <div className="ssr-variant hidden-187ctmn hidden-72rtr7">
                                    <div className="framer-5fffu1-container"
                                        style={{"willChange":"transform","opacity":"0","transform":"translateY(50px)"} as any}>
                                        <div className="framer-m9QRL framer-Fz19O framer-ae7Kc framer-12gnatm framer-v-12gnatm"
                                            data-border="true" data-framer-name="Closed" data-highlight="true"
                                            tabIndex={0}
                                                    ...
                                                    <div className="framer-i4y2k1" data-framer-name="Heading"
                                                        ...
                                                        <div className="framer-sml1t9"
                                                            ...
                                                            <h6 className="framer-text framer-styles-preset-ggytww"
                                                                data-styles-preset="xhIf5qL2n"
                                                                style={{"-FramerTextAlignment":"left","-FramerTextColor":"var(--extracted-1w1cjl5, var(--token-d3c732bc-55cf-476f-8dd2-e130b23f6381, rgb(38, 38, 38)))"} as any}>
                                                                Can I customize workflows for different projects?</h6>
                                                        </div>
                                                        <div className="framer-1wfqlvf" data-framer-name="Icon"
                                                            style={{"opacity":"1"} as any}>
                                                            <div className="framer-1dnucf6" data-framer-name="Plus"
