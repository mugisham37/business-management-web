  ...
  return (
    <div className="mt-36 flex flex-col overflow-hidden px-3">
      ...
      >
        ...
        <h1
          id="about-overview"
          className="mt-2 inline-block bg-gradient-to-br from-foreground to-foreground/80 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-6xl dark:from-foreground dark:to-foreground/70"
        >
          <Balancer>
      ...
      <section aria-labelledby="vision-title" className="mx-auto mt-40">
        <h2
          id="vision-title"
          className="inline-block bg-gradient-to-t from-foreground to-foreground/80 bg-clip-text py-2 text-4xl font-bold tracking-tighter text-transparent md:text-5xl dark:from-foreground dark:to-foreground/70"
        >
          Our Vision
        </h2>
