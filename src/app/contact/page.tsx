...
const page = () => {
    return (
        <section className="framer-2jydna" data-framer-name="Hero Section" id="hero">
            <div className="framer-mimb9t" data-framer-appear-id="mimb9t" data-framer-name="Container"
                    ...
                    <div className="framer-1sdkud6" data-framer-name="Heading Container">
                        <div className="framer-u3qv6s-container">
                            <div className="framer-Fhx2V framer-YF6mi framer-18xhfg8 framer-v-18xhfg8"
                                ...
                                <div className="framer-1l1ajhh" data-framer-name="Icon" style={{opacity: 1}}><svg
                                    className="framer-XkeER framer-qgvfsn" role="presentation"
                                    viewBox="0 0 24 24"
                        ...
                        <div className="framer-4xdrs0" data-framer-name="Heading Content">
                            <div className="framer-1yrpysi" data-framer-name="Container">
                                <div className="framer-1tsw7p6" data-framer-name="Heading"
                                    ...
                                    <h2 className="framer-text framer-styles-preset-199apa9"
                                        ...
                                        We'd Love to Hear from You and Connect</h2>
                                </div>
                                <div className="framer-1tl2748" data-framer-name="Supporting Text"
                                    data-framer-component-type="RichTextContainer"
                                    style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: 0, transform: 'none'}}>
                                    <p className="framer-text framer-styles-preset-wct5n4"
                                        ...
                                        We're here to help with any questions about our product, pricing, or
                ...
                <form className="framer-1e9er38" data-border="true">
                    <div className="framer-1nejg1j" data-framer-name="Content"><label className="framer-od4cgz">
                        <div className="framer-151jb9" data-framer-component-type="RichTextContainer"
                            style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: 0, transform: 'none'}}>
                            <h6 className="framer-text framer-styles-preset-wct5n4"
                                data-styles-preset="OvgFe4dMx">First Name *</h6>
                        </div>
                        <div className="framer-form-text-input framer-form-input-wrapper framer-10yziul"><input
                            data-1p-ignore="true" data-lpignore="true" data-form-type="other"
                            type="text" required={true} name="First Name" placeholder="Jane"
                            className="framer-form-input framer-form-input-empty" defaultValue="" /></div>
                    </label><label className="framer-pb6l2z">
                            <div className="framer-n4mf03" data-framer-component-type="RichTextContainer"
                                style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: 0, transform: 'none'}}>
                                <h6 className="framer-text framer-styles-preset-wct5n4"
                                    data-styles-preset="OvgFe4dMx">Last Name *</h6>
                            </div>
                            <div className="framer-form-text-input framer-form-input-wrapper framer-11k029n"><input
                                data-1p-ignore="true" data-lpignore="true" data-form-type="other"
                                type="text" required={true} name="Last Name" placeholder="Smith"
                                className="framer-form-input framer-form-input-empty" defaultValue="" /></div>
                        </label></div><label className="framer-1r49r81">
                        <div className="framer-1xqtu8d" data-framer-component-type="RichTextContainer"
                            style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: 0, transform: 'none'}}>
                            <h6 className="framer-text framer-styles-preset-wct5n4" data-styles-preset="OvgFe4dMx">
                                Email *</h6>
                        </div>
                        <div className="framer-form-text-input framer-form-input-wrapper framer-bbu85v"><input
                            data-1p-ignore="true" data-lpignore="true" data-form-type="other" type="text"
                            required={true} name="Email *" placeholder="jane@framer.com"
                            className="framer-form-input framer-form-input-empty" defaultValue="" /></div>
                    </label><label className="framer-1ib9i91">
                        <div className="framer-1p5iwjq" data-framer-component-type="RichTextContainer"
                            style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: 0, transform: 'none'}}>
                            <h6 className="framer-text framer-styles-preset-wct5n4" data-styles-preset="OvgFe4dMx">
                                Message</h6>
                        </div>
                        <div className="framer-form-text-input framer-form-input-wrapper framer-k9wiri"><textarea
                            data-1p-ignore="true" data-lpignore="true" data-form-type="other" required={true}
                            name="Message" placeholder="Write your message here"
                            className="framer-form-input"></textarea></div>
                    </label>
                    <div className="framer-dy8cjj-container"><button type="submit"
                        className="framer-Q61OQ framer-YF6mi framer-11bryb1 framer-v-11bryb1"
                        data-framer-name="Default" data-reset="button" tabIndex={0}
                        style={{backgroundColor: 'var(--token-4fb69519-fab9-4e89-9296-e6d87759a143, rgb(10, 141, 255))', height: '100%', width: '100%', borderRadius: '10px', boxShadow: 'rgba(0, 0, 0, 0.1) 0px 1px 3px 0px', opacity: 1}}>
                        <div className="framer-17dl7q9" data-framer-component-type="RichTextContainer"
                            style={{outline: 'none', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', flexShrink: 0, '--extracted-r6o4lv': 'var(--token-44021ae2-4cdd-419c-805c-4b1fd642bfaa, rgb(255, 255, 255))', '--framer-link-text-color': 'rgb(0, 153, 255)', '--framer-link-text-decoration': 'underline', transform: 'none', opacity: 1} as React.CSSProperties}>
                            <p className="framer-text framer-styles-preset-kmaoy8"
                                data-styles-preset="MV92va9oP"
